...
def add_softmax_cross_entropy_loss_for_each_scale(scales_to_logits,
  ...
  for scale, logits in six.iteritems(scales_to_logits):
    ...
    not_ignore_mask = tf.cast(tf.not_equal(scaled_labels,
                                               ignore_label), dtype=tf.float32) * loss_weight
...
def get_model_learning_rate(
  ...
  return tf.compat.v1.where(global_step < slow_start_step, slow_start_learning_rate,
                  learning_rate)
