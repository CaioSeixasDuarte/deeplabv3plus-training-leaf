...
def main(unused_argv):
  ...
  with tf.Graph().as_default():
    ...
    metric_map = {}
    metric_map[predictions_tag] = tf.compat.v1.metrics.mean_iou(
    ...
    tf.compat.v1.logging.info('Eval num images %d', dataset.num_samples)
    tf.compat.v1.logging.info('Eval batch size %d and num batch %d',
